...
export const LEADERS: Leader[] = [
    {
      ...
      'the best future. His mothers wizardy in the kitchen whipping up the tastiest dishes with whatever is ' +
      'available inexpensively at the supermarket, was his first inspiration to create the fusion cuisines for ' +
      'which The Frying Pan became well known. He brings his zeal for fusion cuisines to this restaurant, pioneering ' +
    ...
    },
    {
      ...
      'that we serve meets his exacting tastes. Our chefs dread the tongue lashing that ensues if their dish does not meet ' +
      'his exacting standards. He lives by his motto, You click only if you survive my lick.'
    },
    {
      id: 3,
